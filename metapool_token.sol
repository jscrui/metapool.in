 ...
 * Metapool         5%
 *
 * Max Supply: 1.000.000 MPOOLS
 * Max Tx: 0.2% Max Supply
 * Max Hold: 1.8% Max Supply
 */
...
contract Metapool is ERC20, Ownable{
     ...
     uint256 public tokenLiquidityThreshold = 500 * 10**18; //500 Tokens 0.05% of Max Supply
     uint256 public maxBuyLimit = 6_000 * 10**18; //6000 tokens = 0.6% Max Supply
     uint256 public maxSellLimit = 2_000 * 10**18; //2000 tokens = 0.2% Max Supply
     uint256 public maxWalletLimit = 18_000 * 10**18; //18000 tokens = 1.8% Max Supply
 
     uint256 public genesis_block;
     
     address public marketingWallet = 0xd22ef83B581A392255984074605Bab30Eb359a95; //Marketing
     address public devWallet = 0x1d4a41F51B9f7F41e82Bbe8fdD83FF055995883d; //Developer   
     address public metapoolWallet = 0xFbaeC962321b4A9FE5fe705B15247DD27B5De030; //Pool
     ...
     Taxes public taxes = Taxes(5, 3, 5, 2);
     Taxes public sellTaxes = Taxes(5, 3, 5, 2);
     ...
     constructor() ERC20("Metapool", "MPOOL") {
         //Mint tokens
         ...
         allowedTransfer[metapoolWallet] = true;        
     ...
     function _transfer(address sender, address recipient, uint256 amount) internal override {
         ...
         if (_liquidityMutex || exemptFee[sender] || exemptFee[recipient]){
             ...
             feeswap = sellTaxes.liquidity + sellTaxes.marketing + sellTaxes.dev + sellTaxes.metapool;             
             currentTaxes = sellTaxes;
         }else{
             feeswap =  taxes.liquidity + taxes.marketing + taxes.dev + taxes.metapool;             
             currentTaxes = taxes;
         }
     ...
     function handle_fees(uint256 feeswap, Taxes memory swapTaxes) private mutexLock {
         ...
         if (tokenBalance >= tokenLiquidityThreshold) {
            ...
            uint256 metapoolTokens = tokenBalance - liquidityTokens - marketingTokens - devTokens;
            ...
            uint256 poolAmt = metapoolTokens * afterBalance / toSwap;
            if(poolAmt > 0){
                payable(metapoolWallet).sendValue(poolAmt);
            }
     ...
     function updateMetapoolWallet(address newWallet) external onlyOwner{
         metapoolWallet = newWallet;
     }    
